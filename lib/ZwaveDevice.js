...
class ZwaveDevice extends Homey.Device {
  ...
  _registerCapabilityGet(capabilityId, commandClassId) {
    ...
    if (capabilityGetObj instanceof Error) {
      this.error('Error: registering capability get', { capabilityId, commandClassId }, capabilityGetObj);
      return;
    }
  ...
  _registerCapabilitySet(capabilityId, commandClassId) {
    ...
    if (capabilitySetObj instanceof Error) {
      this.error('Error: registering capability set', { capabilityId, commandClassId }, capabilitySetObj);
      return;
    }
  ...
  _registerCapabilityRealtime(capabilityId, commandClassId) {
    ...
    if (capabilityReportObj instanceof Error) {
      this.error('Error: registering capability realtime', { capabilityId, commandClassId }, capabilityReportObj);
      return;
    }
  ...
  getManifestSettings() {
    if (!this.manifestSettings) {
      const manifest = this.getDriver().manifest;
