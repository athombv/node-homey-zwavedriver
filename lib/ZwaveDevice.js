...
class ZwaveDevice extends MeshDevice {
   ...
   * @param {Object} [userOpts] - The object with options for this capability/commandclass combination. These will extend system options, if available (`/lib/zwave/system/`)
  ...
  registerCapability(capabilityId, commandClassId, userOpts) {
    ...
    try {
      if (!systemOpts) systemOpts = require('./lib/system');
    } catch (err) {
