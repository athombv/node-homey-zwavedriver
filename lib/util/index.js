...
/**
 * Calculate a transitionTime value for ZigBee clusters, it takes two parameters, opts and settings. Opts is the opts object
 * provided by a capabilityListener which can hold a duration property (in milliseconds), settings is an object which can
 * hold a 'transition_time' property (in seconds). If none are available, the default is 0. The valid value range is
 * 0 - 6553.
 * @param opts {object}
 * @param opts.duration {number} - Duration property in milliseconds (preferred over 'transition_time')
